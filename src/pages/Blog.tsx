...
const blogPosts = [
  ...
  {
    id: 7,
    title: "Why Your Business Needs IT Consulting in 2025",
    excerpt: "From cloud migration to cybersecurity, learn how professional IT consulting can transform your business operations and reduce costs.",
  ...
  {
    id: 8,
    title: "Content Writing Tips for Higher Engagement",
    excerpt: "Master the art of writing compelling content that keeps readers hooked and drives conversions. Practical tips from industry experts.",
  ...
  {
    id: 9,
    title: "Mobile-First Design: A Necessity, Not a Choice",
    excerpt: "With over 60% of web traffic coming from mobile devices, learn why mobile-first design is critical for business success.",
  ...
  {
    id: 10,
    title: "E-Commerce SEO: Rank Your Products Higher",
    excerpt: "Specific SEO strategies for online stores. From product schema markup to category optimization, boost your store's organic traffic.",
  ...
  },
  {
    ...
    excerpt: "Navigating the vast landscape of technologies can be overwhelming. Here's a practical guide to picking the right tools for your project.",
  ...
  },
  {
    ...
    excerpt: "From short-form video to AI-generated content, discover the social media trends that will define marketing strategies this year.",
...
const categories = ["All", "Design", "Development", "SEO", "Marketing", "IT"];
